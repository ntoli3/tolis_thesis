...
E_neg = 210e9; % Young Modulus (π.χ. Χάλυβας σε Pa) for psi < 0
E_pos = 100e9; % Young Modulus (π.χ. Χάλυβας σε Pa) for psi >= 0
v_neg  = 0.3;     % Poisson ratio
v_pos  = 0.3;
t_neg  = 0.01;    % Πάχος 1cm
t_pos  = 0.01;
...
k_total = xquad4_stiffness(nodes, E_neg, E_pos, v_neg, v_pos, t_neg, t_pos, nodal_level_sets, psi_handle);
